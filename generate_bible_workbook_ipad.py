...
CONFIG = {
    ...
    # Layout settings
    'page_size': [ 7.3 * inch, 9.7 * inch],  # or A4: (8.27 * inch, 11.69 * inch)
    'margins': {
        'left': 0.5 * inch,
        'right': 0.75 * inch,
        'top': 0.5 * inch,
    ...
    'line_height': 0.35 * inch,  # Change this! Try 0.25, 0.30, 0.35, 0.40, etc.
    ...
    'chars_per_line': 45,  # Average characters that fit on a line
    'whole_word_factor': 0.85,  # Adjustment for not splitting words
    
    # Verse label settings
    'verse_label_width': 0.3 * inch,
